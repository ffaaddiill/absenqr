...
class Site extends CI_Controller {
    ...
    public function check_seo_site(){
        ...
        if ($this->input->post()) {
            ...
            if ($this->validateForm($id)) {
                ...
                if ($post_image['popup_banner']['tmp_name']) {
                    ...
                    try {
                        $picture_db = $this->azure->UploadFileToStorage($post_image['popup_banner'],AZURE_FOLDER_SITE,$filename);
                        $this->Site_model->UpdateSettingRecord($id,'popup_banner',array('value'=>$picture_db));
                ...
                if ($post_image['image_home_channel']['tmp_name']) {
                    ...
                    try {
                        $picture_db = $this->azure->UploadFileToStorage($post_image['image_home_channel'],AZURE_FOLDER_SITE,$filename);
                        $this->Site_model->UpdateSettingRecord($id,'image_home_channel',array('value'=>$picture_db));
