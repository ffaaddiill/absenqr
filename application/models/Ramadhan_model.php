...
class Ramadhan_model extends CI_Model {
    ...
    function UpdateCustomer($id_quiz_customer,$data) {
        $this->db->where('id_quiz_customer',$id_quiz_customer);
        $this->db->update('quiz_customer', $data);
