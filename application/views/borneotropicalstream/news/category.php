    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                ...
                <h1 class="mb-0 bread"><?=!empty($single_category)?$single_category['category_name']:'Blog'?></h1>
            </div>
        </div>
    </div>
</div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 ftco-animate">
        <div class="row">
          <!-- start blog -->
          <?php if(empty($category_news_list)): ?>
          <div class="col">
            <h2 class="mt-5">We don't have any news on this category.</h2>
          </div>
          <?php else: ?>
          <?php foreach($category_news_list as $key=>$val): ?>
