    ...
    <div class="row">
      <div class="col-lg-8 ftco-animate">
        <div class="row">
          ...
          <div class="col-md-12">
            <h2 class="mt-4 mb-0">No result for this search...</h2>
          </div>
          <?php else: ?>
            <div class="col-md-12">
              <h2 class="mt-4 mb-5">The search result :</h2>
            </div>
              ...
              <div class="blog-entry align-self-stretch d-md-flex">
                ...
                <div class="text d-block pl-md-4">
                  <div class="meta mb-3">
                    ...
                    <div class="d-block" style="color: #919191"><a href="#" style="color: #919191">Category <?=$val['news_category_slug']?></a>, Posted by Admin</div>
