...
<div class="container mt25">
    <div class="row">
    	<div class="col-md-9 mb30">
    		<div class="row">
		        <div class="col-md-12">
		        		<h3 class="mt15 mb15"><?=$article['title']?></h3>
		        </div>
	        		<?php if($article['news_type'] == 'news'): ?>
	        			<div class="col-md-12">
        					<img class="img mb20" style="width: 100%;" src="<?=base_url().NEWS_IMG_URL.$article['primary_image']?>">
        				</div>
	        		<?php elseif($article['news_type'] == 'video'): ?>
	        			<div class="col-md-12">
	        				<div class="video-container-onpage">
							<iframe id="ytplayer" type="text/html" src="https://www.youtube.com/embed/<?=$article['video_id']?>?autoplay=0&origin=http://maknaberita.com" frameborder="0">
		        ...
		        <div class="col-md-6 mb15">
		        	<a href="<?=base_url().$article['slug']?>" class="badge badge-primary mr20"><?= $article['category_name'] ?></a><i class="far fa-clock"></i><span class="fs12 ml5"><?=indonesian_date($article['create_date'])?></span>
		        </div>
		        <div class="col-md-6">
