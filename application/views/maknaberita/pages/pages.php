<div class="container mt25">
    <div class="row">
    	<div class="col-md-9 mb30">
    		<div class="row">
		        <div class="col-md-12">
		        	<h3 class="mt15 mb15"><?=$page_content['title']?></h3>
		        </div>
		        <div class="col-md-12">
		            <hr class="section mt0">
		        </div>
		        <?php if(isset($page_content['primary_image'])): ?>
		        <div class="col-md-12">
		        	<img class="img mb20" style="width: 100%;" src="<?=base_url().NEWS_IMG_URL.$page_content['primary_image']?>">
		        </div>
		        <?php endif; ?>
		        <div class="col-md-6">
