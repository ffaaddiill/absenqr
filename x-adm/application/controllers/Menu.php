    ...
    public function list_data() {
        ...
        if ($this->input->post() && $this->input->is_ajax_request()) {
            ...
            foreach ($records as $row => $record) {
                ...
                $return['data'][$row]['actions'] = '<a href="'.site_url($this->class_path_name.'/edit/'.$record['id']).'"><span class="fa fa-edit" aria-hidden="true"></span></a>';
                ...
                $return['data'][$row]['icon'] = $record['icon'];
            }
