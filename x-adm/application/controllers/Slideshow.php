    ...
    public function add() {
        ...
        if ($this->input->post()) {
            ...
            if ($this->validateForm()) {
                ...
                $post['is_video'] = (isset($post['is_video'])) ? 1 : 0;
                $post['image_only'] = (isset($post['image_only'])) ? 1 : 0;
                ...
                if ($post_image['primary_image']['tmp_name']) {
                    ...
                    $this->Slideshow_model->UpdateRecord($id,array('primary_image'=>$this->class_path_name.'/'.$picture_db,'picture_file_name'=>$picture_db));
        ...
        if ($this->input->post() && $this->input->is_ajax_request()) {
            ...
            if (isset($post['id']) && $post['id'] > 0 && ctype_digit($post['id'])) {
                ...
                if ($record && $record['primary_image'] != '') {
                    unlink(UPLOAD_DIR.$record['primary_image']);
                    $this->Slideshow_model->delete_picture($id);
                    $json['success'] = true;
                } else {
