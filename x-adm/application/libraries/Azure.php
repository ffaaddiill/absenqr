 ...
 * @author ivan lubis <ivanhdfgfhfh.z.lubis@gmail.com>
 * @version 3.0
 * @category Library
...
class Azure {
    ...
    public function ResizeUploadImage($source_file,$temporary_folder,$container,$prefix,$filename,$max_width,$max_height) {
        ...
        switch ($image_info['mime']) {
            case 'image/jpeg':
                imagejpeg($tmp, $temporary_folder.$namafile, 100);
                break;

            case 'image/gif':
                imagegif($tmp, $temporary_folder.$namafile, 100);
                break;

            case 'image/png':
                imagepng($tmp, $temporary_folder.$namafile);
                break;
        ...
        $tmp_file_path = $temporary_folder.$namafile;
