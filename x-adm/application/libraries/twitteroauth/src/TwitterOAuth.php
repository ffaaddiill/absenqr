...
class TwitterOAuth extends Config
{
     ...
     */
    public function __construct($param=array()) //parameter type array, modified by fadil
    {
    		//added by fadil
	    		$consumerKey = !empty($param['consumerKey'])?$param['consumerKey']:'';
			$consumerSecret = !empty($param['consumerSecret'])?$param['consumerSecret']:'';
			$oauthToken = !empty($param['oauthToken'])?$param['oauthToken']:null;
			$oauthTokenSecret = !empty($param['oauthTokenSecret'])?$param['oauthTokenSecret']:null;
