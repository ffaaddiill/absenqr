                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="iso_1" value="<?= (isset($post['iso_1'])) ? $post['iso_1']:'' ?>" class="form-control" id="currency_code" placeholder="Code">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="currency_symbol" class="col-sm-2 control-label">Currency Symbol</label>
                                <div class="col-sm-10">
                                    <input name="iso_2" value="<?= (isset($post['iso_2'])) ? $post['iso_2']:'' ?>" class="form-control" id="currency_symbol" placeholder="Symbol">
                                </div>
                            </div>
                        </div>
                    </div>
