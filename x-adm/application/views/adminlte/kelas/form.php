                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="division_code" class="col-sm-2 control-label">Nama Kelas</label>
                                <div class="col-sm-10">
                                    <input name="nama_kelas" value="<?= (isset($post['nama_kelas'])) ? $post['nama_kelas']:'' ?>" class="form-control" id="division_code" placeholder="Nama Kelas">
                                </div>
                            </div>
