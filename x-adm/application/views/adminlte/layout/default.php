...
<head>
  ...
  <!-- jQuery 2.2.0 -->
  <script src="<?=VENDOR_URL?>plugins/jQuery/jQuery-2.2.0.min.js"></script>
  <!-- Bootstrap 3.3.6 -->
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="<?=CSS_URL?>AdminLTE.min.css">
  <!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading all of them to reduce the load. -->
  <link rel="stylesheet" href="<?=CSS_URL?>skins/_all-skins.min.css">
  <link rel="stylesheet" href="<?=CSS_URL?>simci-custom-css.css">
...
<!-- DataTables -->
<script src="<?=VENDOR_URL?>plugins/datatables/jquery.dataTables.min.js"></script>
<script src="<?=VENDOR_URL?>plugins/datatables/dataTables.bootstrap.min.js"></script>
<!-- SlimScroll -->
<script src="<?=VENDOR_URL?>plugins/slimScroll/jquery.slimscroll.min.js"></script>
<!-- FastClick -->
<script src="<?=VENDOR_URL?>plugins/fastclick/fastclick.js"></script>
<!-- AdminLTE App -->
<script src="<?=JS_URL?>app.min.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="<?=JS_URL?>demo.js"></script>
