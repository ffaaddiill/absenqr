            ...
            <table class="table table-striped table-bordered table-hover">
                <thead> 
                    <tr>
                        ...
                        <th class="center" style="width:20%;">Real Amount <span></span></th>
                        <th class="center" style="width:20%;">IDR Amount <span></span></th>
                        <th class="center" style="width:10%;" title="Sort" id="wth_code">WHT Code <span></span></th>
                        
                        <th class="center">Action</th> 
                    <tr>
                        <th></th>
                        <th class="center"><input type="text" name="bd_number" placeholder="Search" class="cari form-control" id="search_bd_number" style="width:100%;"></th>
                        ...
                        <th><input type="text" placeholder="Search" class="cari form-control" id="search_original_amount" style="width:100%;"></th>
                        <th><input type="text" placeholder="Search" class="cari form-control" id="search_idr_amount" style="width:100%;"></th>
                        <th class="center"><input type="text" placeholder="Search" class="cari form-control" id="search_wht_code" style="width:100%;"></th>
                        <th>&nbsp;</th>
                    </tr>
                </thead>
                <tbody></tbody>
...
<script type="text/javascript">
    ...
    the_grid('list_data', '<?= $url_data ?>',1, 10,<?=$page?>,'id_form_bd_item');
