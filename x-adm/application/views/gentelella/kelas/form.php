                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nama_kelas" id="nama_kelas" value="<?= (isset($post['nama_kelas'])) ? html_entity_decode($post['nama_kelas']) : '' ?>"/>
                                </div>
                                <div class="form-group">
