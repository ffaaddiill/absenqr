                            ...
                            <table id="dataTables-list" class="table table-striped table-bordered" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-name="title" data-searchable="true">Page Title</th>
                                        <th data-name="parent_page_title" data-searchable="true">Parent</th>
                                        <th data-name="url_link" data-searchable="true">Url/Link</th>
                                        <th data-name="id_status" data-searchable="false">Status</th>
                                        <th data-name="create_date" data-searchable="true" >Created Date</th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
