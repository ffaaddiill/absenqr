                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                ...
                                <div>
                                    <span class="btn btn-sm btn-light btn-file" style="border:1px solid #ddd">
                                        ...
                                        <input type="file" name="primary_image" class="js-fileinput" accept="image/jpeg,image/png,image/gif">
                                    </span>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <select id="id_area" name="id_area" class="form-control">
                                ...
                                <option <?= (isset($post['id_area']) && $post['id_area']==$area['id']) ? 'selected="selected"' : ' ' ?>value="<?=$area['id']?>"><?=$area['area_name']?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="id_area">Nama Paket</label>
                            <select id="id_package" name="id_package" class="form-control">
                                <option value="0">Choose Package</option>
                                <?php foreach ($packages as $paket): ?>
                                <option <?= (isset($post['id_package']) && $post['id_package']==$paket['id']) ? 'selected="selected"' : ' ' ?>value="<?=$paket['id']?>"><?=$paket['package_name']?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        if(!isset($list_site)){
                            ...
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" class="flat" <?= (isset($post['id_site'][$key]) && !empty($post['id_site'][$key])) ? 'checked="checked"' : ($value['is_default']==1 ?'checked="checked"':'') ?> value="<?=$value['id_site']?>" name="id_site[]" id="id_site"/>&nbsp;<?=$value['site_name']?>
                                </label>
                            </div>
                            <?php
                             }
                            ...
                            <div class="checkbox">
                                <label>
                                    <input <?=$checked_p?> type="checkbox" class="flat" <?= (isset($post['id_site'][$key]) && !empty($post['id_site'][$key])) ? 'checked="checked"' : '' ?> value="<?=$value['id_site']?>" name="id_site[]" id="id_site"/>&nbsp;<?=$value['site_name']?>
                                </label>
                            </div>
                            <?php
                            }
