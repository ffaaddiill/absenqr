                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="category_name">Nama Paket</label>
                                    <input type="text" class="form-control" name="package_name" id="package_name" value="<?= (isset($post['package_name'])) ? $post['package_name'] : '' ?>" placeholder="Nama Paket" />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" class="flat" value="1" name="is_driver" id="is_driver" <?= (isset($post['is_driver']) && !empty($post['is_driver'])) ? 'checked="checked"' : '' ?>/>&nbsp;Termasuk Driver
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" class="flat" value="1" name="is_bbm" id="is_bbm" <?= (isset($post['is_bbm']) && !empty($post['is_bbm'])) ? 'checked="checked"' : '' ?>/>&nbsp;Termasuk BBM
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" class="flat" value="1" name="is_tol" id="is_tol" <?= (isset($post['is_tol']) && !empty($post['is_tol'])) ? 'checked="checked"' : '' ?>/>&nbsp;Termasuk Tol
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" class="flat" value="1" name="is_parkir" id="is_parkir" <?= (isset($post['is_parkir']) && !empty($post['is_parkir'])) ? 'checked="checked"' : '' ?>/>&nbsp;Termasuk Parkir
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group">
