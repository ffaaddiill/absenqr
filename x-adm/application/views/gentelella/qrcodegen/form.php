                    ...
                    <div class="row">
                    		<div class="col-md-3">
                                <div class="form-group">
                                    <label for="primary_image">Qrcode Image</label>
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail fileinput-upload" style="width: 200px; height: 200px;">
                                            <?php if (isset($post['primary_image']) && $post['primary_image'] != '' && !empty($post['primary_image'])): ?>
                                                <img src="<?=base_url().'assets'.'/'.TEMPLATE_DIR.'/'.$post['primary_image']?>" id="post-image" />
                                                <?php /*
                                                <span class="btn btn-danger btn-delete-photo delete-picture" id="delete-picture" data-id="<?= $post['id_qrcode'] ?>" data-type="primary">x</span> */ ?>
                                            <?php else: ?>
                                                <img src="<?=base_url().'assets'.'/'.TEMPLATE_DIR.'/'.'img/no-image.png'?>" id="post-image" />
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
                    		...
                    		<div class="col-lg-9">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="value" id="value" class="form-control"><?= (isset($post['value'])) ? html_entity_decode($post['value']) : '' ?></textarea>
                                </div>
                            </div>
                        </div>
