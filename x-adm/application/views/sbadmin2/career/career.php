...
<table class="table table-striped table-bordered table-hover" id="dataTables-list">
    <thead>
        <tr>
            ...
            <th data-name="division">Division</th>
            <th data-name="title">Title</th>
            <th data-name="publish_date" data-searchable="false">Publish Date</th>
            <th data-name="id_status" data-searchable="false">Status</th>
            <th data-name="count_applicant" data-searchable="false">Submitted</th>
