                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="division_code" class="col-sm-2 control-label">Divisi</label>
                                <div class="col-sm-10">
                                    <input name="name" value="<?= (isset($post['name'])) ? $post['name']:'' ?>" class="form-control" id="division_code" placeholder="Division Name">
                                </div>
                            </div>
                        </div>
                    </div>
