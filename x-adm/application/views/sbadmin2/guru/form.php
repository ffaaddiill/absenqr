                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="division_code" class="col-sm-2 control-label">NIP</label>
                                <div class="col-sm-10">
                                    <input name="kode" value="<?= (isset($post['kode'])) ? $post['kode']:'' ?>" class="form-control" id="division_code" placeholder="Nomor Induk Pegawai">
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="division_code" class="col-sm-2 control-label">Nama Guru</label>
                                <div class="col-sm-10">
                                    <input name="nama_guru" value="<?= (isset($post['nama_guru'])) ? $post['nama_guru']:'' ?>" class="form-control" id="division_code" placeholder="Nama Guru">
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="division_code" class="col-sm-2 control-label">Jenis Kelamin</label>
                                <div class="col-sm-10">
                                    <select name="id_jenis_kelamin" class="form-control">
                                        <option disabled selected>Jenis Kelamin</option>
                                        <?php foreach($jenis_kelamin as $key => $jk) : ?>
                                            <option value="<?= $jk['id_jenis_kelamin'] ?>" <?= ( isset($post['id_jenis_kelamin']) && $post['id_jenis_kelamin'] == $jk['id_jenis_kelamin'] ) ? 'selected':'' ?>>
                                                <?= $jk['jenis_kelamin'] ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                            ...
                            <div class="form-group">
                                <label for="division_code" class="col-sm-2 control-label">Alamat</label>
                                <div class="col-sm-10">
                                    <textarea row="3" name="alamat" class="form-control" id="division_code" placeholder="Jenis Kelamin">
                                        <?= (isset($post['alamat'])) ? $post['alamat']:'' ?>
                                    </textarea>
                                </div>
                            </div>
                        </div>
