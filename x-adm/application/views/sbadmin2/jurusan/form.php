                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="division_code" class="col-sm-2 control-label">Kode Jurusan</label>
                                <div class="col-sm-10">
                                    <input name="kode" value="<?= (isset($post['kode'])) ? $post['kode']:'' ?>" class="form-control" id="division_code" placeholder="Kode Jurusan">
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="division_code" class="col-sm-2 control-label">Nama Jurusan</label>
                                <div class="col-sm-10">
                                    <input name="nama_jurusan" value="<?= (isset($post['nama_jurusan'])) ? $post['nama_jurusan']:'' ?>" class="form-control" id="division_code" placeholder="Nama Jurusan">
                                </div>
                            </div>
