...
<html lang="en">
    <head>
        ...
        <?php /* <link href="<?=VENDOR_URL?>bootstrap-datepicker/css/bootstrap-datepicker3.min.css" rel="stylesheet"/>*/ ?>
        
        <!-- jQuery -->
        <?php /*<script src="<?=GLOBAL_JS_URL?>jquery.min.js"></script> */ ?>
        <script src="<?=GLOBAL_JS_URL?>jquery-3.4.1.min.js"></script>
        
        <!-- bootstrap datepicker JavaScript -->
        <?php /* <script src="<?=VENDOR_URL?>bootstrap-datepicker/js/bootstrap-datepicker.min.js"></script>*/ ?>
        <script src="<?=VENDOR_URL?>gijgo-datetimepicker/gijgo.min.js"></script> 
        <link href="<?=VENDOR_URL?>gijgo-datetimepicker/gijgo.min.css" rel="stylesheet"/>
    ...
    <body>
		...
		<script>
			/*
			$("form").on('focus','.datetimepicker',function() {
            ...
            */
            	...
            	$('.input-group.date input#publish_date').datetimepicker({
            		footer: true,
            		modal: false,
            		format: 'yyyy-mm-dd HH:MM'
            	});
            	
        		$('.input-group.date input#end_date').datetimepicker({
            		footer: true,
            		modal: false,
            		format: 'yyyy-mm-dd HH:MM'
            	});
