                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="division_code" class="col-sm-2 control-label">Nama Pelajaran</label>
                                <div class="col-sm-10">
                                    <input name="nama_mata_pelajaran" value="<?= (isset($post['nama_mata_pelajaran'])) ? $post['nama_mata_pelajaran']:'' ?>" class="form-control" id="division_code" placeholder="Nama Mata Pelajaran">
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="division_code" class="col-sm-2 control-label">Kode Pelajaran</label>
                                <div class="col-sm-10">
                                    <input name="kode" value="<?= (isset($post['kode'])) ? $post['kode']:'' ?>" class="form-control" id="division_code" placeholder="Kode Mata Pelajaran">
                                </div>
                            </div>
