...
<table class="table table-striped table-bordered table-hover" id="dataTables-list">
    <thead>
        <tr>
            ...
            <th data-name="movie_voucher">Voucher</th>
            <th data-name="is_percentage" data-searchable="false">Voucher Type</th>
            <th data-name="discount" data-searchable="false">Discount</th>
            <th data-name="voucher_status" data-searchable="false">Status</th>
