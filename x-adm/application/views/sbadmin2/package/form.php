                            ...
                            <div role="tabpanel" class="tab-pane fade in active" id="info">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                            <label for="discount_percent">Promo Discount</label>
                                            <div class="row">
                                                <div class="col-md-9">
                                                    <input type="number" class="form-control" name="promo_discount" id="promo_discount" value="<?= (isset($post['promo_discount'])) ? $post['promo_discount'] : '' ?>"/>
                                                </div>
                                                <div class="col-md-3">
                                                    %
                                                </div>
                                        ...
                                        <div class="form-group">
                                            <label for="is_topchoice">Top Choice</label>
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" value="1" name="is_topchoice" id="is_topchoice" <?= (isset($post['is_topchoice']) && !empty($post['is_topchoice'])) ? 'checked="checked"' : '' ?>/>Yes
                                                </label>
                                            </div>
                                        </div>
                                        <!-- <div class="form-group">
