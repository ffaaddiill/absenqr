...
<table class="table table-striped table-bordered table-hover" id="dataTables-list">
    <thead>
        <tr>
            ...
            <th data-name="addon_name">Addon Name</th>
            <th data-name="id_status" data-searchable="false">Status</th>
            <th data-name="price_addon" data-searchable="false" data-orderable="false">Price Addon</th>
            <th data-name="position" data-searchable="false" data-orderable="false">Position</th>
