                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="product_type" name="product_type" class="form-control">
                                            	<?php foreach($product_type as $key=>$val) : ?>
                                                	<option <?= (isset($post['product_type']) && $post['product_type']==$val['slug']) ? 'selected="selected"' : ' '?> value="<?=$val['slug']?>"><?=$val['label']?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                        */ ?>
                                        <div class="form-group">
                                            ...
                                            <select id="id_product_category" name="id_product_category" class="form-control">
                                                <option value="0">Choose category</option>
                                                <?php foreach ($categorys as $category): ?>
                                                <option <?= (isset($post['id_product_category']) && $post['id_product_category']==$category['id']) ? 'selected="selected"' : ' ' ?>value="<?=$category['id']?>"><?=$category['category_name']?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" value="1" name="is_productheadline" id="is_productheadline" <?= (isset($post['is_productheadline']) && !empty($post['is_productheadline'])) ? 'checked="checked"' : '' ?>/>Headline Product
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        if(!isset($list_site)){
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" <?= (isset($post['id_site'][$key]) && !empty($post['id_site'][$key])) ? 'checked="checked"' : ($value['is_default']==1 ?'checked="checked"':'') ?> value="<?=$value['id_site']?>" name="id_site[]" id="id_site"/><?=$value['site_name']?>
                                                </label>
                                            </div>
                                            <?php
                                             }
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail fileinput-upload" style="width: 200px; height: 150px;">
                                                    <?php /* if (isset($post['thumbnail_image']) && $post['thumbnail_image'] != '' && file_exists(base_url().FRONTEND_ASSETS_URL . 'product/' . $post['thumbnail_image'])): ?>
                                                        <img src="<?= RELATIVE_base_url().FRONTEND_ASSETS_URL . 'product/' . $post['thumbnail_image'] ?>" id="post-image" />
                                                    ...
                                                    <?php if (isset($post['thumbnail_image']) && $post['thumbnail_image'] != ''): ?>
                                                        ...
                                                        <span onclick="delete_picture(this)" class="btn btn-danger btn-delete-photo delete-picture" id="delete-picture" data-id="<?= $post['id_product'] ?>" data-type="thumbnail">x</span>
                                                    <?php endif; ?>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail fileinput-upload" style="width: 200px; height: 150px;">
                                                    <?php /* if (isset($post['primary_image']) && $post['primary_image'] != '' && file_exists(base_url().FRONTEND_ASSETS_URL . 'product/' . $post['primary_image'])): ?>
                                                        <img src="<?= RELATIVE_base_url().FRONTEND_ASSETS_URL . 'product/' . $post['primary_image'] ?>" id="post-image" />
                                                    ...
                                                    <?php if (isset($post['primary_image']) && $post['primary_image'] != ''): ?>
                                                        ...
                                                        <span onclick="delete_picture(this)" class="btn btn-danger btn-delete-photo delete-picture" id="delete-picture" data-id="<?= $post['id_product'] ?>" data-type="primary">x</span>
                                                    <?php endif; ?>
                                                </div>
                                                <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px;"></div>
                                                <div>
