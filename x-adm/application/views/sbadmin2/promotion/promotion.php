<table class="table table-striped table-bordered table-hover" id="dataTables-list">
    <thead>
        <tr>
            ...
            <th data-name="discount_percent">Discount Percent</th>
            <th data-name="start">Start Date</th>
            <th data-name="end">End Date</th>
            <th data-name="active">Status</th>
            <th data-name="created_at" data-searchable="false">Created Date</th>
        </tr>
    </thead>
</table>
